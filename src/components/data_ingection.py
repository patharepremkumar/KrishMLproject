...
class DataIngection:
    def __init__(self):
        self.ingection_config=DataIngectionCofig()

    def initiate_data_ingestion(self):
        logging.info("Entered the data ingestion method or component")

        try:
            df = pd.read_csv('src\\notebook\\data\\study.csv')
            ...
            return (self.ingection_config.train_data_path,self.ingection_config.test_data_path)
